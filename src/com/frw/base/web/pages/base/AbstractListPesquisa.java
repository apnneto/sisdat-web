 ...
 * @author juliano
 */
public abstract class AbstractListPesquisa<T extends EntidadeBase> extends Panel implements SortableListPanel {
    ...
    public AbstractListPesquisa(String id, UpdatableModalWindow confirmationModal) {
        super(id);
...
//        listContainer.add(exportarExcelLink);
    ...
    public DefaultListColumnHeader getEntityColumnHeader(EntityColumnInfo i) {
        return new DefaultListColumnHeader("headerColumn", i, AbstractListPesquisa.this);
    }
