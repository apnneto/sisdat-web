 ...
 * @author juliano
 */
public abstract class AbstractEntityListPanelNew<T extends EntidadeBase> extends Panel implements SortableListPanel {
    ...
    public AbstractEntityListPanelNew(String id, UpdatableModalWindow confirmationModal) {
        super(id);
...
//        listContainer.add(exportarExcelLink);
    ...
    public DefaultListColumnHeader getEntityColumnHeader(EntityColumnInfo i) {
        return new DefaultListColumnHeader("headerColumn", i, AbstractEntityListPanelNew.this);
    }
