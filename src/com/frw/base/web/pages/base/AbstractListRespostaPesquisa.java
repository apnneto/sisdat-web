 ...
 * @author juliano
 */
public abstract class AbstractListRespostaPesquisa<T extends EntidadeBase> extends Panel implements SortableListPanel {
    ...
    protected boolean enableDeleteLink = false;
    /** flag para controlar  a exibição dos links de edição e exclusão da listagem */
    protected boolean enableEditLink = false;
    ...
    public AbstractListRespostaPesquisa(String id, UpdatableModalWindow confirmationModal) {
        super(id);
...
//        listContainer.add(exportarExcelLink);
    ...
    public DefaultListColumnHeader getEntityColumnHeader(EntityColumnInfo i) {
        return new DefaultListColumnHeader("headerColumn", i, AbstractListRespostaPesquisa.this);
    }
