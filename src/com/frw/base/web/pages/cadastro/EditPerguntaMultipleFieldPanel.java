...
public class EditPerguntaMultipleFieldPanel extends AbstractEntityEditPanel<Pergunta> {
	...
	public EditPerguntaMultipleFieldPanel(String id, UpdatableModalWindow confirmationModal,Pergunta entity, ListPerguntaPanel panelList,Questionario questionario, TipoPergunta tipoPergunta, boolean enableDeleteLink) {
	...
	public Panel getEditEntityPanel(Pergunta entity) {
		return new EditPerguntaMultipleFieldPanel("panel", confirmationModal, entity, panelList, questionario, entity.getTipo(), hasPermissionDelete);
	}
