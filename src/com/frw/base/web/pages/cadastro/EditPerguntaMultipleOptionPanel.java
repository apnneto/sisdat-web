...
public class EditPerguntaMultipleOptionPanel extends AbstractEntityEditPanel<Pergunta> {
	...
	public EditPerguntaMultipleOptionPanel(String id, UpdatableModalWindow confirmationModal,Pergunta entity, ListPerguntaPanel panelList,Questionario questionario, TipoPergunta tipoPergunta, boolean enableDeleteLink) {
	...
	public void addFormFields(final BaseWebBeanForm<Pergunta> form,
		...
		DropDownChoice<Questionario> txtQuestionario = new DropDownChoice<Questionario>(
				"questionario", questionarioFacade.buscarTodosQuestionarios(),
				iChoiceQuestionario);
	...
	public Panel getEditEntityPanel(Pergunta entity) {
		return new EditPerguntaMultipleOptionPanel("panel", confirmationModal, entity, panelList, questionario, entity.getTipo(), hasPermissionDelete);
	}
