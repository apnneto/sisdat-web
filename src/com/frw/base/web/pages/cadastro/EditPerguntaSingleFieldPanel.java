...
public class EditPerguntaSingleFieldPanel extends AbstractEntityEditPanel<Pergunta> {
	...
	public EditPerguntaSingleFieldPanel(String id, UpdatableModalWindow confirmationModal,Pergunta entity, ListPerguntaPanel panelList,Questionario questionario, TipoPergunta tipoPergunta, boolean enableDeleteLink) {
		...
		this.deleteButton.setVisible(hasPermissionDelete);
	}

	@Override
	public void addFormFields(final BaseWebBeanForm<Pergunta> form, final Pergunta entity) {
	...
	public Panel getEditEntityPanel(Pergunta entity) {
		return new EditPerguntaSingleFieldPanel("panel", confirmationModal, entity, panelList, questionario, entity.getTipo(), hasPermissionDelete);
	}
	...
	@Override
	public Pergunta saveEntity(Pergunta entity, AjaxRequestTarget target) throws SistemaException {
